...
/// - `write-all-tokens` — persist a design system in every supported format to its conventional filenames, reporting the written files.
///
/// ## Requirements
///
...
///
/// ### R5 — All-format materialization
///
/// - R5.1 When a design system is written in all formats, the BC shall persist every supported format to its conventional filename in the working directory and report the written files.
///
/// ## Out of scope
///
